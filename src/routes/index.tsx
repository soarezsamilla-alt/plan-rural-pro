    ...
    <main className="min-h-screen bg-background">
      ...
      <Section className="bg-cream pb-14 pt-10 md:pb-20 md:pt-14">
        <div className="mx-auto flex max-w-3xl flex-col items-center text-center">
          ...
          <h1 className="font-display text-3xl leading-[1.15] text-foreground sm:text-4xl lg:text-5xl">
            ...
            <span className="mt-3 block text-2xl font-semibold leading-[1.15] sm:text-3xl lg:text-4xl" style={{ color: "#246E3A" }}>
      ...
      <Section className="py-12 md:py-16">
        <div className="flex justify-center">
          <a
            href="#acceso-completo"
            className="button-soft-pulse inline-flex w-full items-center justify-center rounded-full bg-clay px-6 py-3 text-center text-sm font-bold uppercase tracking-wide text-clay-foreground shadow-lift transition-transform hover:scale-[1.02] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 sm:w-auto"
        ...
        <div className="mt-10 grid items-start gap-6 lg:grid-cols-2">
          ...
          <article className="rounded-3xl border border-border bg-card p-5 shadow-soft">
            ...
            <a
              ...
              className="button-border-glow mt-5 flex w-full items-center justify-center rounded-full border-2 border-primary px-5 py-3 text-xs font-bold uppercase tracking-wide text-primary transition-colors hover:bg-primary hover:text-primary-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
            >
              Quiero el Básico ›
            </a>
          </article>
      ...
      <Section className="bg-cream">
        ...
        <div className="mx-auto mt-10 max-w-xl rounded-3xl border border-border bg-card p-6 text-center shadow-[0_0_40px_-15px_var(--primary)] md:p-8">
          ...
          <a
            href="https://www.instagram.com/plan.rural.oficial"
            target="_blank"
            rel="noopener noreferrer"
